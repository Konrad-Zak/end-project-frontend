...
public class ValidateFormField {
    ...
    private final static int MAX_NUMBER_OF_CHARACTERS = 200;
    private final static int MIN_NUMBER_OF_CHARACTERS = 1;
    ...
    private final static String TEXT_ARENA_ERROR = "Too long message... Max characters: 200";
    private final static String TEXT_ARENA_EMPTY = "Empty message field";
